...
- [[#ebuild][Ebuild]]
  ...
  - [[#编写dotnet项目的ebuild][编写dotnet项目的ebuild]]
...
**** obs-studio
:PROPERTIES:
:HEADER-ARGS: :tangle etc/portage/package.use/obs-studio :mkdirp yes
:END:
#+begin_src shell
...
**** pipewire
:PROPERTIES:
:HEADER-ARGS: :tangle etc/portage/package.use/pipewire :mkdirp yes
:END:
#+begin_src shell
